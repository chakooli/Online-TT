...
public final class hallticket_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write('\n');
      p.getSemester S = null;
      synchronized (session) {
        S = (p.getSemester) _jspx_page_context.getAttribute("S", PageContext.SESSION_SCOPE);
        if (S == null){
          S = new p.getSemester();
      ...
      p.getSession E = null;
      synchronized (session) {
        E = (p.getSession) _jspx_page_context.getAttribute("E", PageContext.SESSION_SCOPE);
        if (E == null){
          E = new p.getSession();
          _jspx_page_context.setAttribute("E", E, PageContext.SESSION_SCOPE);
        }
...
String ses = E.printSession();
      ...
      out.write("      <br><br><br><h1><font size = 6><a href=\"/index.html\">Hall Ticket</a></font></h1>\n");
      out.write("      \n");
      out.write("    </div>\n");
      out.write("    \n");
      out.write("</header>\n");
      ...
      out.write("    <h1><img class=\"imgl borderedbox\" src=\"\" alt=\"image\"><br></h1>\n");
      out.write("      ");
      out.write("\n");
